...
describe('Register Component', () => {
  ...
  beforeEach(() => {
    ...
    const wrapper = shallowMount(Register, {
      global: {
        plugins: [createTestingPinia(), [VueQueryPlugin, { queryClient: new QueryClient() }]],
        provide: {
  ...
  it('should set all default values correctly', () => {
    ...
    expect(register.confirmPassword).toBe('');
    expect(register.registerAccount.login).toBe('');
    expect(register.registerAccount.password).toBe('');
    expect(register.registerAccount.email).toBe('');
  });
  ...
  it('should register when password match', async () => {
    ...
    register.login = filledRegisterAccount.login;
    register.email = filledRegisterAccount.email;
    register.password = filledRegisterAccount.password;
